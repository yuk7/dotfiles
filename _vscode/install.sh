...
mv -f "$DESTDIR3/settings.json" "$DESTDIR3/settings.json.bak" >/dev/null 2>&1
...
then
	...
	mv -f "$DESTDIR3/settings.json.bak" "$DESTDIR3/settings.json" >/dev/null 2>&1
	...
	mv -f "$DESTDIR3_DATA/argv.json.bak" "$DESTDIR3_DATA/argv.json" >/dev/null 2>&1
fi
